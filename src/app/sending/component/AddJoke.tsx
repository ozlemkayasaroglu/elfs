...
const router =useRouter();
  ...
  const [otherJokeAuthor, setOtherJokeAuthor] = useState<string>();
  const [otherJokeText, setOtherJokeText] = useState<string>();
  const [otherJokeImage, setOtherJokeImage] = useState<string>();

  async function newNote() {
   try{
    await axios.post("/api/joke", {
      text: otherJokeText,
      image: otherJokeImage,
      author: otherJokeAuthor,
    });
    MySwal.fire({
      icon: "success",
                ...
                <div className="space-y-12 p-8">
                  <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">
                      Add to your Joke and sent for Elf!
                    </h2>
                        ...
                        <div className="mt-2">
                          <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                setOtherJokeAuthor(e.target.value)
                              }}
                              className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                              placeholder="mommy4_0"
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-span-full">
                        ...
                        <div className="mt-2">
                          <textarea
                            ...
                            name="about"
                            onChange={(e) => {
                              setOtherJokeText(e.target.value)
                            }}
                            rows={3}
                            ...
                            <div className="mt-4 flex text-sm leading-6 text-gray-600">
                              ...
                              >
                                ...
                                <input
                                  ...
                                  className="sr-only"
                                  onChange={(e) => {
                                    setOtherJokeImage(e.target.value)
                                  }}
                                />
                              </label>
